...
system('cls');
system('title Admin Control Panel Finder by ppz.c0l1n www.jcs.security');
...
print "\n                              +-++-++-++-++-++-+
                              ...
                              +-++-++-++-++-++-+\n";
print "+-+-+-+-+-+-+ +-+-+-+-+-+ +-+-+-+-+-+-+-+-+-+ +-+-+-+-+-+-+-+-+ +-+-+-+-+-+-+-+-+-+
|J|i|e|s|u|s| |C|r|i|s|t| |S|u|p|e|r|s|t|a|r| |S|e|c|u|r|i|t|y| |L|a|b|r|a|t|o|r|y|
+-+-+-+-+-+-+ +-+-+-+-+-+ +-+-+-+-+-+-+-+-+-+ +-+-+-+-+-+-+-+-+ +-+-+-+-+-+-+-+-+-+\n";
print "                        AdminPanelFinder Version 0.1\n";
print "                           shit-code by ppz.c0l1n\n" ;
print "                          website:www.jcs.security\n\n";
print "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx\n" ;
print "\n";

print " Enter the website you want to scan \n";
print" As an Example: www.domaine.com or www.victim.com/[path]{if need]\n";
print" --> ";
$site=<STDIN>;
chomp $site;
...
@path1=('CMS/','admin/','administrator/','moderator/','webadmin/','adminarea/','bb-admin/','adminLogin/','admin_area/','panel-administracion/','instadmin/',
...
@path2=('CMS/','admin/','administrator/','moderator/','webadmin/','adminarea/','bb-admin/','adminLogin/','admin_area/','panel-administracion/','instadmin/',
